...
if __name__ == '__main__':
    ...
    for f in os.listdir(ulib.path_data['work']):
        ...
        with open(ulib.path_data['processed']+'sws_before_rem_intervals.csv', mode='w', newline='') as csvfile:
            ...
            sws_related = []
            rem_related = []
            result_file.writerow(['SWS-like','REM-like'])
            ...
            for i in range(len(sws_related)-1):
                result_file.writerow([ulib.get_interval_in_seconds(sws_related[i][2],sws_related[i+1][1]),ulib.get_interval_in_seconds(rem_related[i][2],rem_related[i+1][1])])
            ...
            for l in states:
                for s in states[l]:
                    ...
                    if s[0] == 'SWS-like':
                        ...
                        result_file.writerow([ulib.get_interval_in_seconds(s_t[1],s_t[2]),ulib.get_interval_in_seconds(s[1],s[2])])
